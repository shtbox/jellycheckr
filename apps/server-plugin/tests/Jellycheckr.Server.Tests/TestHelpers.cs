...
internal sealed class StubConfigService : IConfigService
{
    ...
    public EffectiveConfigResponse GetEffectiveConfig(string? userId)
    {
        return new EffectiveConfigResponse
        {
            ...
            EnforcementMode = _adminConfig.EnforcementMode,
            ServerFallbackEpisodeThreshold = _adminConfig.ServerFallbackEpisodeThreshold,
            ServerFallbackMinutesThreshold = _adminConfig.ServerFallbackMinutesThreshold,
            ServerFallbackTriggerMode = _adminConfig.ServerFallbackTriggerMode,
